...
const { createRoom, getAllRooms, getRoomById, getRoomsBySpaceTypeId, updateRoom, deleteRoom, getRoomAvailability } = require('../controllers/roomController');
...
router.get('/by-space-type/:spaceTypeId', getRoomsBySpaceTypeId);
